...
public class RecipeManager
{
	public VanillaEnchantmentRecipe[] recipes = new VanillaEnchantmentRecipe[] {
			...
			new VanillaEnchantmentRecipe(Enchantment.LOOT_BONUS_BLOCKS, 64, Material.NETHER_STAR, EnchantmentTarget.TOOL),
			...
			new VanillaEnchantmentRecipe(Enchantment.MENDING, 48, Material.ANVIL, EnchantmentTarget.BREAKABLE),
			...
			new VanillaEnchantmentRecipe(Enchantment.PROTECTION_ENVIRONMENTAL, 16, Material.IRON_BLOCK, EnchantmentTarget.ARMOR),
			...
			new VanillaEnchantmentRecipe(Enchantment.SWEEPING_EDGE, 3, Material.NETHERITE_SCRAP, EnchantmentTarget.WEAPON),
			new VanillaEnchantmentRecipe(Enchantment.THORNS, 64, Material.POINTED_DRIPSTONE, EnchantmentTarget.ARMOR),
			new VanillaEnchantmentRecipe(Enchantment.DURABILITY, 64, Material.OBSIDIAN, EnchantmentTarget.BREAKABLE),
